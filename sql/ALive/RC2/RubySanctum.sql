...
( '0', '40419', '0', '6', '100', '1', '7000', '10000', '10000', '13000', '11', '75417', '1', '1', '', '', '', '', '', '', '', '', 'Angreifer der Schmorschuppen Schockwelle'),
('1', '40419', '0', '6', '100', '1', '10000', '12000', '8000', '11000', '11', '15248', '1', '1', '', '', '', '', '', '', '', '', 'Angreifer der Schmorschuppen Spalten');


-- Herbeirufer der Schmorschuppe
DELETE FROM `creature_ai_scripts` WHERE (`creature_id` = '40417');
Insert INTO `creature_ai_scripts` VALUES
( '0', '40417', '0', '6', '100', '1', '7000', '10000', '10000', '13000', '11', '75413', '1', '1', '', '', '', '', '', '', '', '', 'Herbeirufer der Schmorschuppe Flammenwelle'),
('1', '40417', '0', '6', '100', '1', '5000', '7000', '8000', '13000', '11', '75412', '1', '1', '', '', '', '', '', '', '', '', 'Herbeirufer der Schmorschuppe Versengen');

-- Elite der Schmorschuppe
DELETE FROM `creature_ai_scripts` WHERE (`creature_id`='40421');
INSERT INTO `creature_ai_scripts` VALUES 
('0', '40421', '0', '6', '100', '1', '3000', '8000', '6000', '12000', '11', '15621', '1', '1', '', '', '', '', '', '', '', '', 'Elite der Schmorschuppe Schaedelkracher');

-- Kommandant der Schmorschuppen
DELETE FROM `creature_ai_scripts` WHERE (`creature_id`='40423');
INSERT INTO `creature_ai_scripts` VALUES 
( '0', '40423', '0', '6', '100', '1', '5000', '7000', '8000', '12000', '11', '75414', '0', '1', '', '', '', '', '', '', '', '', 'Kommandant der Schmorschuppen Sammelruf'),
('1', '40423', '0', '6', '100', '1', '7000', '10000', '6000', '11000', '11', '13737', '1', '1', '', '', '', '', '', '', '', '', 'Kommandant der Schmorschuppen Toedlicher stoss');
